...
public class ImageBean {
    ...
    public static List<ImageBean> getTestData() {
        ...
        list.add(new ImageBean(R.mipmap.image1, "相信自己,你努力的样子真的很美", 1));
        list.add(new ImageBean(R.mipmap.image2, "极致简约,梦幻小屋", 3));
        list.add(new ImageBean(R.mipmap.image3, "超级卖梦人", 3));
        list.add(new ImageBean(R.mipmap.image4, "夏季新搭配", 1));
        list.add(new ImageBean(R.mipmap.image5, "绝美风格搭配", 1));
        list.add(new ImageBean(R.mipmap.image6, "微微一笑 很倾城", 3));
        return list;
    }

    public static List<ImageBean> getTestData2() {
        List<ImageBean> list = new ArrayList<>();
        list.add(new ImageBean(R.mipmap.image7, "听风.赏雨", 3));
        list.add(new ImageBean(R.mipmap.image8, "迪丽热巴.迪力木拉提", 1));
        list.add(new ImageBean(R.mipmap.image9, "爱美.人间有之", 3));
        list.add(new ImageBean(R.mipmap.image10, "洋洋洋.气质篇", 1));
        list.add(new ImageBean(R.mipmap.image11, "生活的态度", 3));
        return list;
    }
    ...
    public static List<ImageBean> getTestDataVideo() {
        ...
        list.add(new ImageBean(R.mipmap.image7, "听风.赏雨", 1));
        list.add(new ImageBean(R.mipmap.image8, "迪丽热巴.迪力木拉提", 1));
        list.add(new ImageBean(R.mipmap.image9, "爱美.人间有之", 1));
        list.add(new ImageBean(R.mipmap.image10, "洋洋洋.气质篇", 1));
        list.add(new ImageBean(R.mipmap.image11, "生活的态度", 1));
        return list;
    }
